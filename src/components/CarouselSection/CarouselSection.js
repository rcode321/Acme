	...
	return (
		...
		>
			...
			<div class="text-white ">
				...
				<h4 class="font-semibold text-base mb-6 text-zinc-50">
					We help our partners deliver industry leading results with a commitment to
					excellence, thought-provoking insights and experience distribution. We are
					laser focused on our shared goal- helping clients achieve their objectives.
				</h4>
				<a
