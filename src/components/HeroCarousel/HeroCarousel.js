	...
	return (
		<>
			...
			<div
				...
				className="carousel slide relative block lg:hidden"
				data-bs-ride="carousel"
			>
				<div className="carousel-indicators absolute right-0 bottom-0 left-0 flex justify-center p-0 mb-1">
					<button
						type="button"
				...
				<div className="carousel-inner relative w-full overflow-hidden bg-insight ">
					...
					<div className="carousel-item relative float-left w-full my-5 ">
						<div className="flex justify-center flex-col  m-6 boxshadow">
							<div className="mb-5">
								<h2 className="text-white text-2xl">ACME Insights</h2>
								<p className="text-white">
