...
const FooterDesktop = () => {
	return (
		<footer class="text-center lg:text-left bg-neutral-500 text-white hidden lg:block mt-14">
			<div class="flex justify-center items-center lg:justify-between p-6 border-b border-indigo-600 max-w-6xl mx-auto">
				<div class="mr-12 hidden lg:block">
					<span>Call us at 111-222-3333</span>
					<div>
						<span>for more information</span>
					</div>
				</div>
				<div class="flex justify-center">
					<span className="-my-1 pr-5">Social Share</span>
